...
This page contains all **11** controls and control enhancements in the Planning (PL) family from the vendored NIST SP 800-53 Revision 5 OSCAL catalog.
...
## PL-01 (Policy and Procedures) { #pl-01 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/pl-1)

---

## PL-02 (System Security and Privacy Plans) { #pl-02 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/pl-2)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/pl-4)

---

## PL-04 (01) (Social Media and External Site/Application Usage Restrictions) { #pl-04-01 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/pl-4-1)

---

## PL-07 (Concept of Operations) { #pl-07 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/pl-7)

---

## PL-08 (Security and Privacy Architectures) { #pl-08 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/pl-8)

---

## PL-08 (01) (Defense in Depth) { #pl-08-01 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/pl-8-1)

---

## PL-08 (02) (Supplier Diversity) { #pl-08-02 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/pl-8-2)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/pl-9)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/pl-10)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/pl-11)
