...
This page contains all **22** controls and control enhancements in the Risk Assessment (RA) family from the vendored NIST SP 800-53 Revision 5 OSCAL catalog.
...
## RA-01 (Policy and Procedures) { #ra-01 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-1)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-2)

---

## RA-02 (01) (Impact-level Prioritization) { #ra-02-01 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-2-1)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-3)

---

## RA-03 (01) (Supply Chain Risk Assessment) { #ra-03-01 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-3-1)

---

## RA-03 (02) (Use of All-source Intelligence) { #ra-03-02 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-3-2)

---

## RA-03 (03) (Dynamic Threat Awareness) { #ra-03-03 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-3-3)

---

## RA-03 (04) (Predictive Cyber Analytics) { #ra-03-04 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-3-4)

---

## RA-05 (Vulnerability Monitoring and Scanning) { #ra-05 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-5)

---

## RA-05 (02) (Update Vulnerabilities to Be Scanned) { #ra-05-02 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-5-2)

---

## RA-05 (03) (Breadth and Depth of Coverage) { #ra-05-03 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-5-3)

---

## RA-05 (04) (Discoverable Information) { #ra-05-04 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-5-4)

---

## RA-05 (05) (Privileged Access) { #ra-05-05 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-5-5)

---

## RA-05 (06) (Automated Trend Analyses) { #ra-05-06 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-5-6)

---

## RA-05 (08) (Review Historic Audit Logs) { #ra-05-08 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-5-8)

---

## RA-05 (10) (Correlate Scanning Information) { #ra-05-10 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-5-10)

---

## RA-05 (11) (Public Disclosure Program) { #ra-05-11 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-5-11)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-6)

---

## RA-07 (Risk Response) { #ra-07 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-7)

---

## RA-08 (Privacy Impact Assessments) { #ra-08 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-8)

---

## RA-09 (Criticality Analysis) { #ra-09 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-9)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/ra-10)
