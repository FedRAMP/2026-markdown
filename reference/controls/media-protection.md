...
This page contains all **20** controls and control enhancements in the Media Protection (MP) family from the vendored NIST SP 800-53 Revision 5 OSCAL catalog.
...
## MP-01 (Policy and Procedures) { #mp-01 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-1)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-2)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-3)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-4)

---

## MP-04 (02) (Automated Restricted Access) { #mp-04-02 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-4-2)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-5)

---

## MP-05 (03) (Custodians) { #mp-05-03 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-5-3)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-6)

---

## MP-06 (01) (Review, Approve, Track, Document, and Verify) { #mp-06-01 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-6-1)

---

## MP-06 (02) (Equipment Testing) { #mp-06-02 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-6-2)

---

## MP-06 (03) (Nondestructive Techniques) { #mp-06-03 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-6-3)

---

## MP-06 (07) (Dual Authorization) { #mp-06-07 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-6-7)

---

## MP-06 (08) (Remote Purging or Wiping of Information) { #mp-06-08 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-6-8)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-7)

---

## MP-07 (02) (Prohibit Use of Sanitization-resistant Media) { #mp-07-02 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-7-2)
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-8)

---

## MP-08 (01) (Documentation of Process) { #mp-08-01 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-8-1)

---

## MP-08 (02) (Equipment Testing) { #mp-08-02 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-8-2)

---

## MP-08 (03) (Controlled Unclassified Information) { #mp-08-03 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-8-3)

---

## MP-08 (04) (Classified Information) { #mp-08-04 }
...
!!! quote ""
    ...
    **External Link for Additional Information:** [myctrl.tools](https://myctrl.tools/frameworks/nist-800-53-r5/mp-8-4)
